...
/***/ "./src/app/main/dashboards/professional/professional.component.html":
/*!**************************************************************************!*\
  !*** ./src/app/main/dashboards/professional/professional.component.html ***!
  \**************************************************************************/
/*! no static exports found */
...
module.exports = "<style>\n    /* ---------------------------------------------- /*\n * Skill-bars\n/* ---------------------------------------------- */\n\n.skill-bar {\n\tbackground: #C4C4C4;\n\tdisplay: table;\n\theight: 4px;\n\twidth: 100%;\n\tmargin: 10px -2px 20px -2px;\n}\n\n.skill-bar .skill-rate-on {\n\tbackground: #5cb85c;\n}\n\n.skill-rate-on, .skill-rate-off {\n\tdisplay: table-cell;\n\tborder-left: 2px solid #FFF;\n\tborder-right: 2px solid #FFF;\n}\n</style>\n<div id=\"dashboard-analytics\" class=\"page-layout blank grey-100-bg\">\n\n  <div class=\"main-widget\">\n\n      <div class=\"position-relative p-24 mat-green-600-bg\"\n           fxLayout=\"row\" fxLayoutAlign=\"space-between center\">\n          <div fxLayout=\"column\" fxLayoutAlign=\"start start\">\n              <span class=\"h2\">Hours</span>\n              <span class=\"h5 secondary-text\">Number of hours worked by month</span>\n          </div>\n          <div fxLayout=\"row\" fxLayoutAlign=\"start center\">\n                <div class=\"py-8 px-12 border-radius-2 line-height-1 mr-8 cursor-pointer\"\n                (click)=\"widget1SelectedYear = '2012'\"\n                [ngClass]=\"{'green-300-bg': widget1SelectedYear === '2012'}\">\n               2012\n           </div>\n           <div class=\"py-8 px-12 border-radius-2 line-height-1 mr-8 cursor-pointer\"\n                   (click)=\"widget1SelectedYear = '2013'\"\n                   [ngClass]=\"{'green-300-bg': widget1SelectedYear === '2013'}\">\n                  2013\n              </div>\n              <div class=\"py-8 px-12 border-radius-2 line-height-1 mr-8 cursor-pointer\"\n                   (click)=\"widget1SelectedYear = '2014'\"\n                   [ngClass]=\"{'green-300-bg': widget1SelectedYear === '2014'}\">\n                  2014\n              </div>\n              <div class=\"py-8 px-12 border-radius-2 line-height-1 mr-8 cursor-pointer\"\n                   (click)=\"widget1SelectedYear = '2015'\"\n                   [ngClass]=\"{'green-300-bg': widget1SelectedYear === '2015'}\">\n                  2015\n              </div>\n              <div class=\"py-8 px-12 border-radius-2 line-height-1 mr-8 cursor-pointer\"\n                   (click)=\"widget1SelectedYear = '2016'\"\n                   [ngClass]=\"{'green-300-bg': widget1SelectedYear === '2016'}\">\n                  2016\n              </div>\n              <div class=\"py-8 px-12 border-radius-2 line-height-1 cursor-pointer\"\n                   (click)=\"widget1SelectedYear = '2017'\"\n                   [ngClass]=\"{'green-300-bg': widget1SelectedYear === '2017'}\">\n                  2017\n              </div>\n              <div class=\"py-8 px-12 border-radius-2 line-height-1 cursor-pointer\"\n              (click)=\"widget1SelectedYear = '2018'\"\n              [ngClass]=\"{'green-300-bg': widget1SelectedYear === '2018'}\">\n             2018\n         </div>\n         <div class=\"py-8 px-12 border-radius-2 line-height-1 cursor-pointer\"\n         (click)=\"widget1SelectedYear = '2019'\"\n         [ngClass]=\"{'green-300-bg': widget1SelectedYear === '2019'}\">\n        2019\n    </div>\n    <div class=\"py-8 px-12 border-radius-2 line-height-1 cursor-pointer\"\n         (click)=\"widget1SelectedYear = '2020'\"\n         [ngClass]=\"{'green-300-bg': widget1SelectedYear === '2020'}\">\n        2020\n    </div>\n    <div class=\"py-8 px-12 border-radius-2 line-height-1 cursor-pointer\"\n    (click)=\"widget1SelectedYear = '2021'\"\n    [ngClass]=\"{'green-300-bg': widget1SelectedYear === '2021'}\">\n    2021\n</div>\n          </div>\n      </div>\n\n      <div class=\"position-relative h-256 pb-16 mat-green-600-bg\">\n          <canvas baseChart\n                  [datasets]=\"widgets.widget1.datasets[widget1SelectedYear]\"\n                  [labels]=\"widgets.widget1.labels\"\n                  [colors]=\"widgets.widget1.colors\"\n                  [options]=\"widgets.widget1.options\"\n                  [chartType]=\"widgets.widget1.chartType\">\n          </canvas>\n      </div>\n\n  </div>\n\n  <div class=\"content\">\n\n    <div class=\"left mr-lg-32\">\n        <!-- Widget 5 -->\n        <div class=\"pt-0 pb-24 font-size-18 font-weight-300\">\n           My Workflow Overview Graph\n        </div>\n\n        <div class=\"album-card auto-width auto-height\">\n            <div class=\"position-relative pb-16\">\n                        <div class=\"h-300\">\n                                <ngx-charts-pie-chart\n                                *albumIfOnDom\n                                [scheme]=\"widgets.widget7.scheme\"\n                                [results]=\"widgets.widget7.devices\"\n                                [doughnut]=\"true\">\n                            </ngx-charts-pie-chart>\n                        </div>                 \n                <div class=\"p-16\" fxLayout=\"row wrap\" fxLayoutAlign=\"center center\">\n                    <div class=\"px-16 \" fxFlex=\"100\" fxFlex.gt-xs=\"33.33\" fxLayout=\"column\" fxLayoutAlign=\"start center\"\n                         *ngFor=\"let device of widgets.widget7.devices\">\n                        <div class=\"h4 secondary-text\">{{device.name}}</div>\n                        <div class=\"h2 font-weight-300 py-8\">{{device.value}}%</div>\n\n                    </div>\n\n                </div>\n            </div>\n        </div>\n        <!-- / Widget 5 -->\n\n        <!-- Widget 6 -->\n        <div class=\"pt-48 pb-24 font-size-18 font-weight-300\">\n            My Stats with clients\n        </div>\n\n        <div class=\"album-card auto-width p-0\">\n                <div class=\"mat-green-600-bg\">\n\n                        <div class=\"p-16\" fxLayout=\"row\" fxLayoutAlign=\"space-between center\">\n                            <div class=\"pr-16\">\n                                <div class=\"h1 font-weight-300\">Project</div>\n                                <div class=\"h5 secondary-text\">Details in Descending</div>\n                            </div>\n                        </div>\n\n                        <div class=\"p-16 pt-8\" fxLayout=\"row\" fxLayoutAlign=\"space-between end\">\n                            <div class=\"font-size-48 font-weight-300 line-height-1\">{{widgets.aboutProject.projectsCount}} Clients</div>\n                            <div fxLayout=\"row\" fxLayoutAlign=\"start center\">\n                                <mat-icon >trending_up</mat-icon>\n                                <div class=\"ml-8\">65,600\n                                   Happy Customers\n                                </div>\n                            </div>\n                        </div>\n\n                    </div>\n\n                    <mat-tab-group backgroundColor=\"primary\">\n                        <div *ngFor=\"let proj of widgets.aboutProject.projectsdata\">\n                                <mat-tab label={{proj.label}} >\n                                        <div class=\"h-450 my-16\">\n                                            <div class=\"p-16 pt-8 pb-16\" fxLayout=\"column\" fxLayoutAlign=\"center center\">\n                                                <div class=\"blue-grey-fg font-size-72 line-height-72\">\n                                                    # &nbsp;{{proj.projectsWorked}}\n                                                </div>\n                                                <div class=\"h3 secondary-text font-weight-500\">{{proj.projectsWorkedSubTitle}}\n                                                </div>\n                                                <div class=\"py-8\">\n                                                    <button mat-raised-button color=\"primary\" aria-label=\"Follow\" (click)=\"viewProjectDetails(proj.id)\">Click to View project Details</button>\n                                                </div>\n                                                </div>\n                                                <div class=\"py-8 mh-16 border-top\" fxLayout=\"row wrap\" fxLayoutAlign=\"start center\">\n                                        \n                                                        <div class=\"py-8 border-right\" fxLayout=\"column\" fxLayoutAlign=\"center center\"\n                                                             fxFlex=\"100\" fxFlex.gt-sm=\"50\">\n                                                            <span class=\"mat-display-1 mb-0\">\n                                                                 &nbsp;{{proj.projectDuration}}\n                                                            </span>\n                                                            <span class=\"h4\">months duration</span>\n                                                        </div>\n                                        \n                                                        <div class=\"py-8\" fxLayout=\"column\" fxLayoutAlign=\"center center\" fxFlex=\"100\"\n                                                             fxFlex.gt-sm=\"50\">\n                                                            <span class=\"mat-display-1 mb-0\">\n                                                                  # &nbsp;{{proj.technologiesUsed}}\n                                                            </span>\n                                                            <span class=\"h4\">Technologies Used</span>\n                                                        </div>\n                                                    </div>\n                                                    <div class=\"py-8 mh-16 p-16 border-top\" fxLayout=\"row wrap\" fxLayoutAlign=\"start center\">\n                                        \n                                                        <div [innerHTML]=\"proj.content.content\"></div>\n            \n                                                    </div>\n                                        </div>\n                                    </mat-tab>\n                        </div>\n                       \n                    </mat-tab-group>\n\n        </div>\n        <!-- / Widget 6 -->\n\n    </div>\n\n    <div class=\"right\">\n\n        <div fxLayout=\"row wrap\" fxLayout.gt-md=\"column\">\n\n            <!-- Widget 8 -->\n            <div class=\"mb-48\" [ngClass.lt-lg]=\"'mr-32'\" [ngClass.xs]=\"'mr-0'\">\n\n                <div class=\"pb-24 font-size-18 font-weight-300\">\n                    Experience level on Technologies\n                </div>\n\n                <div class=\"album-card\">\n\n                        <div class=\"profile-widget p-24\">\n                                <div class=\"h3 secondary-text font-weight-500\">Adobe PhotoShop</div>\n                                <div class=\"skill-bar\">\n                                    <div class=\"skill-rate-on\"></div>\n                                    <div class=\"skill-rate-on\"></div>\n                                    <div class=\"skill-rate-on\"></div>\n                                    <div class=\"skill-rate-off\"></div>\n                                </div>\n                        <div class=\"h3 secondary-text font-weight-500\">HTML5 / CSS3 / SCSS</div>\n                            <div class=\"skill-bar\">\n                                <div class=\"skill-rate-on\"></div>\n                                <div class=\"skill-rate-on\"></div>\n                                <div class=\"skill-rate-on\"></div>\n                                <div class=\"skill-rate-on\"></div>\n                            </div>\n                            <div class=\"h3 secondary-text font-weight-500\">Angular Flux Architecture</div>\n                            <div class=\"skill-bar\">\n                                <div class=\"skill-rate-on\"></div>\n                                <div class=\"skill-rate-on\"></div>\n                                <div class=\"skill-rate-on\"></div>\n                                <div class=\"skill-rate-on\"></div>\n                            </div>\n                            <div class=\"h3 secondary-text font-weight-500\">Bootstrap / Angular Material</div>\n                            <div class=\"skill-bar\">\n                                <div class=\"skill-rate-on\"></div>\n                                <div class=\"skill-rate-on\"></div>\n                                <div class=\"skill-rate-on\"></div>\n                                <div class=\"skill-rate-on\"></div>\n                            </div>\n                            <div class=\"h3 secondary-text font-weight-500\">Javascript / Typescript</div>\n                            <div class=\"skill-bar\">\n                                <div class=\"skill-rate-on\"></div>\n                                <div class=\"skill-rate-on\"></div>\n                                <div class=\"skill-rate-on\"></div>\n                                <div class=\"skill-rate-off\"></div>\n                            </div>\n                            <div class=\"h3 secondary-text font-weight-500\">Angular (1.x & 2, 4, 7, 9+)</div>\n                            <div class=\"skill-bar\">\n                                <div class=\"skill-rate-on\"></div>\n                                <div class=\"skill-rate-on\"></div>\n                                <div class=\"skill-rate-on\"></div>\n                                <div class=\"skill-rate-on\"></div>\n                            </div>\n                            <div class=\"h3 secondary-text font-weight-500\">Node JS / Angular Cli</div>\n                            <div class=\"skill-bar\">\n                                <div class=\"skill-rate-on\"></div>\n                                <div class=\"skill-rate-on\"></div>\n                                <div class=\"skill-rate-on\"></div>\n                                <div class=\"skill-rate-off\"></div>\n                            </div>\n                            <div class=\"h3 secondary-text font-weight-500\">New Relic / Google Analytics</div>\n                            <div class=\"skill-bar\">\n                                <div class=\"skill-rate-on\"></div>\n                                <div class=\"skill-rate-on\"></div>\n                                <div class=\"skill-rate-on\"></div>\n                                <div class=\"skill-rate-on\"></div>\n                            </div>\n                            <div class=\"h3 secondary-text font-weight-500\">Crownpeak Content Managment on Application Level</div>\n                            <div class=\"skill-bar\">\n                                <div class=\"skill-rate-on\"></div>\n                                <div class=\"skill-rate-on\"></div>\n                                <div class=\"skill-rate-on\"></div>\n                                <div class=\"skill-rate-on\"></div>\n                            </div>\n                            <div class=\"h3 secondary-text font-weight-500\">SQL</div>\n                            <div class=\"skill-bar\">\n                                <div class=\"skill-rate-on\"></div>\n                                <div class=\"skill-rate-on\"></div>\n                                <div class=\"skill-rate-off\"></div>\n                                <div class=\"skill-rate-off\"></div>\n                            </div>\n                            <div class=\"h3 secondary-text font-weight-500\">MongoDB</div>\n                            <div class=\"skill-bar\">\n                                <div class=\"skill-rate-on\"></div>\n                                <div class=\"skill-rate-on\"></div>\n                                <div class=\"skill-rate-on\"></div>\n                                <div class=\"skill-rate-off\"></div>\n                            </div>\n                            <div class=\"h3 secondary-text font-weight-500\">R Studio</div>\n                            <div class=\"skill-bar\">\n                                <div class=\"skill-rate-on\"></div>\n                                <div class=\"skill-rate-on\"></div>\n                                <div class=\"skill-rate-on\"></div>\n                                <div class=\"skill-rate-on\"></div>\n                            </div>\n                            <div class=\"h3 secondary-text font-weight-500\">Git Lab CI/CD</div>\n                            <div class=\"skill-bar\">\n                                <div class=\"skill-rate-on\"></div>\n                                <div class=\"skill-rate-on\"></div>\n                                <div class=\"skill-rate-on\"></div>\n                                <div class=\"skill-rate-off\"></div>\n                            </div>\n                            <div class=\"h3 secondary-text font-weight-500\">AWS EC2 Instance / S3 Buckets</div>\n                            <div class=\"skill-bar\">\n                                <div class=\"skill-rate-on\"></div>\n                                <div class=\"skill-rate-on\"></div>\n                                <div class=\"skill-rate-off\"></div>\n                                <div class=\"skill-rate-off\"></div>\n                            </div>\n                            <div class=\"h3 secondary-text font-weight-500\">Google Cloud Platform</div>\n                            <div class=\"skill-bar\">\n                                <div class=\"skill-rate-on\"></div>\n                                <div class=\"skill-rate-on\"></div>\n                                <div class=\"skill-rate-off\"></div>\n                                <div class=\"skill-rate-off\"></div>\n                            </div>\n                            <div class=\"h3 secondary-text font-weight-500\">Unit / Integration Testing</div>\n                            <div class=\"skill-bar\">\n                                <div class=\"skill-rate-on\"></div>\n                                <div class=\"skill-rate-on\"></div>\n                                <div class=\"skill-rate-on\"></div>\n                                <div class=\"skill-rate-off\"></div>\n                            </div>\n                        </div>\n                </div>\n\n            </div>\n\n            <!-- / Widget 8 -->\n        </div>\n\n    </div>\n\n</div>\n\n\n</div>\n"

/***/ }),

/***/ "./src/app/main/dashboards/professional/professional.component.scss":
/*!**************************************************************************!*\
  !*** ./src/app/main/dashboards/professional/professional.component.scss ***!
  \**************************************************************************/
/*! no static exports found */
...
module.exports = "#dashboard-analytics .main-widget{display:flex;flex-direction:column}#dashboard-analytics .content{display:flex;flex:1 1 auto;padding:32px;min-width:0}@media (max-width: 1279px){#dashboard-analytics .content{flex-direction:column}}#dashboard-analytics .content .left{display:flex;flex-direction:column;flex:1 1 auto;min-width:0}#dashboard-analytics .content .left .widget{flex:1 1 auto;min-width:0}#dashboard-analytics .content .right{display:flex;flex:0 0 auto;width:320px;min-width:320px}@media (max-width: 1279px){#dashboard-analytics .content .right{flex:1 0 100%;margin-top:32px;width:100%;min-width:0;max-width:none}}@media (max-width: 1279px){#dashboard-analytics .content .right .album-card{width:100%;min-width:0;max-width:none}}\n"

/***/ }),

/***/ "./src/app/main/dashboards/professional/professional.component.ts":
/*!************************************************************************!*\
  !*** ./src/app/main/dashboards/professional/professional.component.ts ***!
  \************************************************************************/
...
/* harmony import */ var _professional_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./professional.service */ "./src/app/main/dashboards/professional/professional.service.ts");
/* harmony import */ var _album_animations__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../@album/animations */ "./src/@album/animations/index.ts");
...
var ProfessionalComponent = /** @class */ (function () {
     ...
     */
    function ProfessionalComponent(_professionalDashboardService, myService, router) {
        this._professionalDashboardService = _professionalDashboardService;
        this.myService = myService;
        this.router = router;
        this.widget1SelectedYear = '2021';
     ...
     */
    ProfessionalComponent.prototype._registerCustomChartJSPlugin = function () {
                ...
                chart.data.datasets.forEach(function (dataset, i) {
                    ...
                    if (!meta.hidden) {
                        meta.data.forEach(function (element, index) {
                            ...
                            var dataString = dataset.data[index].toString() + 'H';
    ...
    ProfessionalComponent.prototype.viewProjectDetails = function (id) {
    ...
    ProfessionalComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./professional.component.html */ "./src/app/main/dashboards/professional/professional.component.html"),
            styles: [__webpack_require__(/*! ./professional.component.scss */ "./src/app/main/dashboards/professional/professional.component.scss")],
            encapsulation: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewEncapsulation"].None,
            animations: _album_animations__WEBPACK_IMPORTED_MODULE_2__["albumAnimations"],
        }),
        __metadata("design:paramtypes", [_professional_service__WEBPACK_IMPORTED_MODULE_1__["ProfessionalDashboardService"],
...
/***/ "./src/app/main/dashboards/professional/professional.module.ts":
/*!*********************************************************************!*\
  !*** ./src/app/main/dashboards/professional/professional.module.ts ***!
  \*********************************************************************/
/*! exports provided: ProfessionalDashboardModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ProfessionalDashboardModule", function() { return ProfessionalDashboardModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _professional_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./professional.component */ "./src/app/main/dashboards/professional/professional.component.ts");
...
/* harmony import */ var _professional_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./professional.service */ "./src/app/main/dashboards/professional/professional.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    {
        path: '**',
        component: _professional_component__WEBPACK_IMPORTED_MODULE_5__["ProfessionalComponent"],
        resolve: {
            data: _professional_service__WEBPACK_IMPORTED_MODULE_8__["ProfessionalDashboardService"]
        }
    }
];
var ProfessionalDashboardModule = /** @class */ (function () {
    function ProfessionalDashboardModule() {
    }
    ProfessionalDashboardModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [
                _professional_component__WEBPACK_IMPORTED_MODULE_5__["ProfessionalComponent"]
            ],
            imports: [
            ...
            providers: [
                _professional_service__WEBPACK_IMPORTED_MODULE_8__["ProfessionalDashboardService"]
            ]
        })
    ], ProfessionalDashboardModule);
    return ProfessionalDashboardModule;
}());
...
/***/ "./src/app/main/dashboards/professional/professional.service.ts":
/*!**********************************************************************!*\
  !*** ./src/app/main/dashboards/professional/professional.service.ts ***!
  \**********************************************************************/
/*! exports provided: ProfessionalDashboardService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ProfessionalDashboardService", function() { return ProfessionalDashboardService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var ProfessionalDashboardService = /** @class */ (function () {
    /**
     * Constructor
     *
     * @param {HttpClient} _httpClient
     */
    function ProfessionalDashboardService(_httpClient) {
     ...
     */
    ProfessionalDashboardService.prototype.resolve = function (route, state) {
        var _this = this;
     ...
     * @returns {Promise<any>}
     */
    ProfessionalDashboardService.prototype.getWidgets = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this._httpClient.get('api/professional-dashboard-widgets')
    ...
    ProfessionalDashboardService = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])(),
        __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]])
    ], ProfessionalDashboardService);
    return ProfessionalDashboardService;
}());
