...
module.exports = "#dashboard-project>.sidebar{width:280px;min-width:280px;max-width:280px}#dashboard-project>.center>.header{height:160px;min-height:160px;max-height:160px;background:#595959;background:linear-gradient(to right, #595959, #b67878);position:relative;color:#FFFFFF}#dashboard-project>.center>.header .selected-project{background:rgba(0,0,0,0.12);color:#FFFFFF;padding:8px 16px;height:40px;line-height:24px;font-size:16px}#dashboard-project>.center>.header .project-selector{margin-left:1px;border-radius:0;background:rgba(0,0,0,0.12)}#dashboard-project>.center>.header .project-selector mat-icon{color:#FFFFFF}#dashboard-project>.center>.content{flex:1}#dashboard-project>.center>.content mat-tab-group{height:100%}#dashboard-project>.center>.content mat-tab-group .mat-tab-body-wrapper{flex-grow:1}#dashboard-project>.center>.content .mat-tab-label-container{padding:0 24px}#dashboard-project .widget.widget5 .gridline-path.gridline-path-horizontal{display:none}#dashboard-project .summary-header{padding:24px;height:600px;min-height:600px;background:#00f260;background:linear-gradient(to right, #00f260, #0575e6)}@media (max-width: 599px){#dashboard-project .summary-header{height:550px;min-height:400px}}#dashboard-project .summary-header .hero-text{margin:80px 24px}@media (max-width: 599px){#dashboard-project .summary-header .hero-text{margin:32px 24px}}#dashboard-project .summary-header .hero-text .h1{color:white;font-size:48px;font-weight:400;letter-spacing:0.01em;text-align:center}@media (max-width: 599px){#dashboard-project .summary-header .hero-text .h1{font-size:32px}}#dashboard-project .summary-header .hero-text .h3{color:rgba(255,255,255,0.75);max-width:480px;text-align:center;margin-top:16px;font-weight:300;letter-spacing:0.05em}@media (max-width: 599px){#dashboard-project .summary-header .hero-text .h3{font-size:14px}}#dashboard-project .price-tables{flex:1 0 auto;margin-top:-192px}@media (max-width: 599px){#dashboard-project .price-tables{margin-top:-128px}}#dashboard-project .price-tables .price-table{margin:12px}#dashboard-project .faq{flex:1 0 auto;margin:96px auto;max-width:840px}#dashboard-project .faq .title{font-size:32px;font-weight:300;text-align:center;margin-bottom:64px;padding:0 16px}#dashboard-project .faq .item{padding:24px}#dashboard-project .faq .item .question{font-size:18px;margin-bottom:8px}#dashboard-project .faq .item .answer{font-size:16px;line-height:1.5;color:rgba(0,0,0,0.54)}#dashboard-project .product-image{overflow:hidden;width:250px;height:128px;margin-right:16px;margin-bottom:16px;border:3px solid rgba(0,0,0,0.12)}#dashboard-project .product-image img{height:100%;width:auto;max-width:none}\n"
