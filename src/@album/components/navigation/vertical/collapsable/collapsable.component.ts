...
@Component({
    selector   : 'album-nav-vertical-collapsable',
    templateUrl: './collapsable.component.html',
    styleUrls  : ['./collapsable.component.scss'],
    animations : albumAnimations
})
export class AlbumNavVerticalCollapsableComponent implements OnInit, OnDestroy
{
    @Input()
    ...
    ngOnInit(): void
    {
        ...
        this._albumNavigationService.onItemCollapsed
    ...
    toggleOpen(ev): void
    {
        ...
        this._albumNavigationService.onItemCollapsed.next(this.item);
        this._albumNavigationService.onItemCollapseToggled.next();
    }
