import { ChangeDetectorRef, Component, ElementRef, EventEmitter,
     HostBinding, HostListener, Input, OnDestroy, OnInit, Output, Renderer2, RendererStyleFlags2, ViewEncapsulation } from '@angular/core';
...
import { AlbumSidebarService } from './sidebar.service';
...
export class AlbumSidebarComponent implements OnInit, OnDestroy
{
    // Name
    @Input()
    name: string;
    ...
    ngOnInit(): void
    {
        ...
        this._albumConfigService.config
            ...
            .subscribe((config) => {
                this._albumConfig = config;
            });

        // Register the sidebar
        this._albumSidebarService.register(this.name, this);
    ...
    ngOnDestroy(): void
    {
        ...
        this._albumSidebarService.unregister(this.name);
    ...
    private _showBackdrop(): void
    {
        ...
        this._backdrop.classList.add('album-sidebar-overlay');

        // Add a class depending on the invisibleOverlay option
        if ( this.invisibleOverlay )
        {
            this._backdrop.classList.add('album-sidebar-overlay-invisible');
        }
