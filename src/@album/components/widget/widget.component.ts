import { AfterContentInit, Component, ContentChildren, ElementRef, HostBinding, QueryList, 
...
export class AlbumWidgetComponent implements AfterContentInit
{
    @HostBinding('class.flipped')
    flipped = false;

    @ContentChildren(AlbumWidgetToggleDirective, {descendants: true})
    toggleButtons: QueryList<AlbumWidgetToggleDirective>;
