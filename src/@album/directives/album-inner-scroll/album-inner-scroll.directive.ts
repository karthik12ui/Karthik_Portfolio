...
export class AlbumInnerScrollDirective implements OnInit, OnDestroy
{
    // Private
    private _parent: any;
     ...
     * @param {AlbumMatchMediaService} _albumMediaMatchService
     * @param {Renderer2} _renderer
     */
    constructor(
        private _elementRef: ElementRef,
        private _albumMediaMatchService: AlbumMatchMediaService,
    ...
    ngOnInit(): void
    {
        ...
        this._albumMediaMatchService.onMediaChange
