...
@Directive({
    selector: '[albumPerfectScrollbar]'
})
export class AlbumPerfectScrollbarDirective implements AfterViewInit, OnDestroy
{
     ...
     */
    @Input()
    set albumPerfectScrollbarOptions(value)
    {
        // Merge the options
        this._options = _.merge({}, this._options, value);
    }

    get albumPerfectScrollbarOptions(): any
    {
        // Return the options
    ...
    ngAfterViewInit(): void
    {
        ...
        if ( this.albumPerfectScrollbarOptions.updateOnRouteChange )
        {
            this._router.events
                .pipe(
    ...
    _init(): void
    {
        ...
        this.ps = new PerfectScrollbar(this.elementRef.nativeElement, {
            ...this.albumPerfectScrollbarOptions
        });
    }
